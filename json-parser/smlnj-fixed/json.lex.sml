...
in
  ...
  in
    ...
    type prestrm = ULexBuffer.stream
    ...
    fun streamifyReader readFn strm = (yystreamifyReader' 0 readFn strm, INITIAL)
    fun streamifyInstream strm = (yystreamifyInstream' 0 strm, INITIAL)
